...
/// holds three compact stompboxes at 0.69:1 AND a Whammy treadle at 1.07:1; any
...
extension GearArtView {
    ...
    static func panelIsLight(for item: GearItem?) -> Bool {
        ...
        // printed black labels on black metal. Pedals answer from their own
        // finish, which is main's rule and the same idea one layer down.
