...
- `"Marshall JCM800"` → `marshall-jcm800.usdz` (the amp head **and** 4×12 cab are one model)
...
Resolution order: `GearItem.modelName` → `<slug>.usdz` → `category-<category>.usdz` → procedural.
